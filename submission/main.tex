...
% ── Theory ───────────────────────────────────────────────────────────────────
\subsection{Theory: optimal low-rank drift certificates}
...
This theorem does not say that linear reconstruction is the best possible
detector. It says that, for a fixed rank and nominal training set,
Fig.~\ref{fig:anomaly} uses the optimal linear certificate. The observed AUC drop
at high ranks has a clear interpretation: the monitor becomes expressive enough
to reconstruct abnormal windows as well as nominal ones.
